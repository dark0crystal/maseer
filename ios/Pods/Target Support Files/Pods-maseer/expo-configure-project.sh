...
with_node \
  ...
  --target "/Users/almardas/maseer/ios/Pods/Target Support Files/Pods-maseer/ExpoModulesProvider.swift" \
  --entitlement "/Users/almardas/maseer/ios/maseer/maseer.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-camera" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-gl" "expo-haptics" "expo-image-picker" "expo-keep-awake" "expo-linking" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
